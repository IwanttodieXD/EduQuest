...
<body>
    <div class="container">
        <div class="left-panel">
            <img src="controller-graduation.png" alt="Logo" />
            <h1>Welcome to EDUQUEST</h1>
            <p>A gamified learning management system. Where your learning is the ultimate adventure!</p>
        </div>
        ...
        <div class="right-panel">
            ...
            <div class="signup-box" id="signupBox">
                ...
                <form action="signup.php" method="POST">
                    ...
                    <input type="password" name="password" id="new-password" placeholder="Choose a password" />
                    ...
                    <div class="user-type-selection">
                        ...
                        <div class="radio-options">
                            <div>
                                <input type="radio" name="user-type" id="teacher" name="user-type" value="teacher">
                                <label for="teacher">Teacher</label>
                            </div>
                            <div>
                                <input type="radio" name="user-type" id="student" name="user-type" value="student">
